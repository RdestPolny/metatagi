...
- NIGDY nie dodawaj na końcu nazwy sklepu, brandu ani domeny (np. "| Tania Książka", "| taniaksiazka.pl", "- Bookland")
...
Stwórz zoptymalizowane SEO metatagi dla tego produktu."""
        ...
        # Usuwanie brandingu z meta title (na wszelki wypadek)
        brand_patterns = [
            r'\s*[\|\-]\s*Tania Książka.*
    except Exception as e:
...
,
        ...
        for pattern in brand_patterns:
            meta_title = re.sub(pattern, '', meta_title, flags=re.IGNORECASE)
