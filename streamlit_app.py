...
- Używaj separatorów | lub - dla czytelności
- Uwzględnij nazwę marki/sklepu jeśli jest istotna
- Bądź konkretny i zachęcający do kliknięcia

ZASADY TWORZENIA META DESCRIPTION:
- Maksymalnie 160 znaków (włącznie ze spacjami)
- Jedno lub dwa zdania informacyjne
- Zawieraj call-to-action gdy to możliwe
